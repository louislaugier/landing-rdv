...
export default function Home() {
	return (
		<div style={{ height: '100vh', backgroundColor: secondary, position: 'relative', top: -60, zIndex: -1, paddingTop: 60, display: 'flex', justifyContent: 'flex-start', color: 'white', fontSize: 48 }}>
